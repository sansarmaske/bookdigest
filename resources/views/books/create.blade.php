                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('books.store') }}">
                        ...
                        <div class="mb-4 relative">
                            ...
                            <div id="suggestions-dropdown" class="absolute z-10 w-full bg-white border border-gray-300 rounded-md shadow-lg mt-1 hidden max-h-60 overflow-y-auto">
    ...
    <script type="module">
        class BookAutocomplete {
            ...
            createSuggestionElement(book, index) {
                ...
                item.className = 'p-3 hover:bg-gray-100 cursor-pointer border-b border-gray-200 last:border-b-0 suggestion-item';
                item.setAttribute('data-index', index);
                
                item.innerHTML = `
                    <div class="font-semibold text-gray-900">${this.escapeHtml(book.title)}</div>
                    <div class="text-sm text-gray-600">by ${this.escapeHtml(book.author)} (${book.publication_year || 'Unknown'})</div>
                    <div class="text-xs text-gray-500 mt-1">${this.escapeHtml(book.genre || 'Unknown genre')}</div>
                `;
